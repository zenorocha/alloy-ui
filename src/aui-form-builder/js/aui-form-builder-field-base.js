...
var L = A.Lang,
    ...
    CSS_ALERT = getClassName('alert'),
    CSS_ALERT_INFO = getClassName('alert', 'info'),
    CSS_CLEARFIX = getClassName('clearfix'),
    CSS_COMPONENT = getClassName('component'),
    CSS_FB_DROP_ZONE = getClassName('form', 'builder', 'drop', 'zone'),
    CSS_FB_FIELD = getClassName('form', 'builder', 'field'),
    CSS_FB_FIELD_SELECTED = getClassName('form', 'builder', 'field', 'selected'),
    CSS_FB_UNIQUE = getClassName('form', 'builder', 'unique'),
    CSS_ICON = getClassName('icon'),
    CSS_ICON_ASTERISK = getClassName('icon', 'asterisk'),
    CSS_ICON_PLUS = getClassName('icon', 'plus'),
    CSS_ICON_QUESTION_SIGN = getClassName('icon', 'question', 'sign'),
    CSS_ICON_TRASH = getClassName('icon', 'trash'),
    CSS_ICON_WRENCH = getClassName('icon', 'wrench'),
    CSS_WIDGET = getClassName('widget'),
