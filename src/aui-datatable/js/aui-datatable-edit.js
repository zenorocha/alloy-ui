...
var Lang = A.Lang,
    ...
    CSS_CELLEDITOR_EDIT = getClassName('celleditor', 'edit'),
    CSS_CELLEDITOR_EDIT_ADD_OPTION = getClassName('celleditor', 'edit', 'add', 'option'),
    CSS_CELLEDITOR_EDIT_DD_HANDLE = getClassName('celleditor', 'edit', 'dd', 'handle'),
    CSS_CELLEDITOR_EDIT_DELETE_OPTION = getClassName('celleditor', 'edit', 'delete', 'option'),
    CSS_CELLEDITOR_EDIT_HIDE_OPTION = getClassName('celleditor', 'edit', 'hide', 'option'),
    CSS_CELLEDITOR_EDIT_INPUT_NAME = getClassName('celleditor', 'edit', 'input', 'name'),
    CSS_CELLEDITOR_EDIT_INPUT_VALUE = getClassName('celleditor', 'edit', 'input', 'value'),
    CSS_CELLEDITOR_EDIT_LABEL = getClassName('celleditor', 'edit', 'label'),
    CSS_CELLEDITOR_EDIT_LINK = getClassName('celleditor', 'edit', 'link'),
    CSS_CELLEDITOR_EDIT_OPTION_ROW = getClassName('celleditor', 'edit', 'option', 'row'),
    CSS_CELLEDITOR_ELEMENT = getClassName('celleditor', 'element'),
    CSS_CELLEDITOR_OPTION = getClassName('celleditor', 'option'),
    CSS_DATATABLE_EDITABLE = getClassName('datatable', 'editable'),
    CSS_ICON = getClassName('icon'),
    CSS_ICON_GRIP_DOTTED_VERTICAL = getClassName('icon', 'grip', 'dotted', 'vertical'),
