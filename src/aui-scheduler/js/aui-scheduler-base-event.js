...
var Lang = A.Lang,
    ...
    CSS_SCHEDULER_CONTROLS = getClassName('scheduler-base', 'controls'),

    CSS_SCHEDULER_HD = getClassName('scheduler-base', 'hd'),
    CSS_SCHEDULER_ICON_NEXT = getClassName('scheduler-base', 'icon', 'next'),
    CSS_SCHEDULER_ICON_PREV = getClassName('scheduler-base', 'icon', 'prev'),
    CSS_SCHEDULER_NAV = getClassName('scheduler-base', 'nav'),
    CSS_SCHEDULER_TODAY = getClassName('scheduler-base', 'today'),
    CSS_SCHEDULER_VIEW = getClassName('scheduler-base', 'view'),
    CSS_SCHEDULER_VIEW_ = getClassName('scheduler-base', 'view', ''),
    CSS_SCHEDULER_VIEW_DATE = getClassName('scheduler-base', 'view', 'date'),
    CSS_SCHEDULER_VIEW_NOSCROLL = getClassName('scheduler-view', 'noscroll'),
    CSS_SCHEDULER_VIEW_SCROLLABLE = getClassName('scheduler-view', 'scrollable'),
    CSS_SCHEDULER_VIEW_SELECTED = getClassName('active'),
    CSS_BTN = getClassName('btn'),
    CSS_ICON_CHEVRON_RIGHT = getClassName('icon', 'chevron', 'right'),
    CSS_ICON_CHEVRON_LEFT = getClassName('icon', 'chevron', 'left'),
    CSS_SCHEDULER_VIEWS = getClassName('scheduler-base', 'views'),

    CSS_SCHEDULER_EVENT = getClassName('scheduler-event'),
    CSS_SCHEDULER_EVENT_ALL_DAY = getClassName('scheduler-event', 'all', 'day'),
    CSS_SCHEDULER_EVENT_CONTENT = getClassName('scheduler-event', 'content'),
    CSS_SCHEDULER_EVENT_DISABLED = getClassName('scheduler-event', 'disabled'),
    CSS_SCHEDULER_EVENT_HIDDEN = getClassName('scheduler-event', 'hidden'),
    CSS_SCHEDULER_EVENT_ICON_DISABLED = getClassName('scheduler-event', 'icon', 'disabled'),
    CSS_SCHEDULER_EVENT_ICON_MEETING = getClassName('scheduler-event', 'icon', 'meeting'),
    CSS_SCHEDULER_EVENT_ICON_REMINDER = getClassName('scheduler-event', 'icon', 'reminder'),
    CSS_SCHEDULER_EVENT_ICON_REPEATED = getClassName('scheduler-event', 'icon', 'repeated'),
    CSS_SCHEDULER_EVENT_ICONS = getClassName('scheduler-event', 'icons'),
    CSS_SCHEDULER_EVENT_MEETING = getClassName('scheduler-event', 'meeting'),
    CSS_SCHEDULER_EVENT_PAST = getClassName('scheduler-event', 'past'),
    CSS_SCHEDULER_EVENT_REMINDER = getClassName('scheduler-event', 'reminder'),
    CSS_SCHEDULER_EVENT_REPEATED = getClassName('scheduler-event', 'repeated'),
    CSS_SCHEDULER_EVENT_SHORT = getClassName('scheduler-event', 'short'),
    CSS_SCHEDULER_EVENT_TITLE = getClassName('scheduler-event', 'title'),
