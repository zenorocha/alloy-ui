...
var Lang = A.Lang,
    ...
    CSS_SVT_TABLE_DATA = getClassName('scheduler-view', 'table', 'data'),

    CSS_SCHEDULER_EVENT = getClassName('scheduler-event'),
    CSS_SCHEDULER_EVENT_DISABLED = getClassName('scheduler-event', 'disabled'),
    CSS_SCHEDULER_EVENT_PROXY = getClassName('scheduler-event', 'proxy'),

    CSS_SCHEDULER_TODAY = getClassName('scheduler', 'today'),
    CSS_SCHEDULER_TODAY_HD = getClassName('scheduler', 'today', 'hd'),

    CSS_SCHEDULER_VIEW_DAY_COLDATA = getClassName('scheduler-view', 'coldata'),
    CSS_SCHEDULER_VIEW_DAY_COLGRID = getClassName('scheduler-view', 'colgrid'),
    CSS_SCHEDULER_VIEW_DAY_GRID = getClassName('scheduler-view', 'grid'),
    CSS_SCHEDULER_VIEW_DAY_GRID_CONTAINER = getClassName('scheduler-view', 'grid', 'container'),
    CSS_SCHEDULER_VIEW_DAY_HEADER_COL = getClassName('scheduler-view', 'day', 'header', 'col'),
    CSS_SCHEDULER_VIEW_DAY_HEADER_DAY = getClassName('scheduler-view', 'day', 'header', 'day'),
    CSS_SCHEDULER_VIEW_DAY_HEADER_DAY_FIRST = getClassName('scheduler-view', 'day', 'header', 'day', 'first'),
    CSS_SCHEDULER_VIEW_DAY_HEADER_TABLE = getClassName('scheduler-view', 'day', 'header', 'table'),
    CSS_SCHEDULER_VIEW_DAY_HEADER_VIEW_LABEL = getClassName('scheduler-view', 'day', 'header', 'view', 'label'),
    CSS_SCHEDULER_VIEW_DAY_ICON_GRIP_HORIZONTAL = getClassName('scheduler-view', 'icon', 'grip', 'horizontal'),
    CSS_SCHEDULER_VIEW_DAY_MARKER_DIVISION = getClassName('scheduler-view', 'marker', 'division'),
    CSS_SCHEDULER_VIEW_DAY_MARKERCELL = getClassName('scheduler-view', 'markercell'),
    CSS_SCHEDULER_VIEW_DAY_MARKERS = getClassName('scheduler-view', 'markers'),
    CSS_SCHEDULER_VIEW_DAY_RESIZER = getClassName('scheduler-view', 'day', 'resizer'),
    CSS_SCHEDULER_VIEW_DAY_RESIZER_ICON = getClassName('scheduler-view', 'day', 'resizer', 'icon'),
    CSS_SCHEDULER_VIEW_DAY_TABLE = getClassName('scheduler-view', 'day', 'table'),
    CSS_SCHEDULER_VIEW_DAY_TABLE_COL = getClassName('scheduler-view', 'day', 'table', 'col'),
    CSS_SCHEDULER_VIEW_DAY_TABLE_COL_SHIM = getClassName('scheduler-view', 'day', 'table', 'col', 'shim'),
    CSS_SCHEDULER_VIEW_DAY_TABLE_COLBLANK = getClassName('scheduler-view', 'day', 'table', 'colblank'),
    CSS_SCHEDULER_VIEW_DAY_TABLE_COLDAY = getClassName('scheduler-view', 'day', 'table', 'colday'),
    CSS_SCHEDULER_VIEW_DAY_TABLE_COLTIME = getClassName('scheduler-view', 'day', 'table', 'coltime'),
    CSS_SCHEDULER_VIEW_DAY_TABLE_TIME = getClassName('scheduler-view', 'day', 'table', 'time'),
