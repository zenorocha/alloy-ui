...
var Lang = A.Lang,
    ...
    CSS_ICON_ARROWSTOP_LEFT = getClassName('icon', 'arrowstop-1-l'),
    CSS_ICON_ARROWSTOP_RIGHT = getClassName('icon', 'arrowstop-1-r'),
    CSS_SVT_COLGRID = getClassName('scheduler-view', 'table', 'colgrid'),
    CSS_SVT_COLGRID_FIRST = getClassName('scheduler-view', 'table', 'colgrid', 'first'),
    CSS_SVT_COLGRID_TODAY = getClassName('scheduler-view', 'table', 'colgrid', 'today'),
    CSS_SVT_CONTAINER = getClassName('scheduler-view', 'table', 'container'),
    CSS_SVT_EVENTS_OVERLAY_NODE = getClassName('scheduler-view', 'table', 'events', 'overlay', 'node'),
    CSS_SVT_EVENTS_OVERLAY_NODE_BODY = getClassName('scheduler-view', 'table', 'events', 'overlay', 'node', 'body'),
    CSS_SVT_EVENTS_OVERLAY_NODE_CLOSE = getClassName('scheduler-view', 'table', 'events', 'overlay', 'node', 'close'),
    CSS_SVT_HEADER_COL = getClassName('scheduler-view', 'table', 'header', 'col'),
    CSS_SVT_HEADER_DAY = getClassName('scheduler-view', 'table', 'header', 'day'),
    CSS_SVT_HEADER_TABLE = getClassName('scheduler-view', 'table', 'header', 'table'),
    CSS_SVT_MORE = getClassName('scheduler-view', 'table', 'more'),
    CSS_SVT_ROW = getClassName('scheduler-view', 'table', 'row'),
    CSS_SVT_ROW_CONTAINER = getClassName('scheduler-view', 'table', 'row', 'container'),
    ...
    CSS_SVT_TABLE_DATA_COL_TITLE_DOWN = getClassName('scheduler-view', 'table', 'data', 'col', 'title', 'down'),
    CSS_SVT_TABLE_DATA_COL_TITLE_FIRST = getClassName('scheduler-view', 'table', 'data', 'col', 'title', 'first'),
    CSS_SVT_TABLE_DATA_COL_TITLE_NEXT = getClassName('scheduler-view', 'table', 'data', 'col', 'title', 'next'),
    CSS_SVT_TABLE_DATA_COL_TITLE_TODAY = getClassName('scheduler-view', 'table', 'data', 'col', 'title', 'today'),
    CSS_SVT_TABLE_DATA_EVENT = getClassName('scheduler-view', 'table', 'data', 'event'),
    CSS_SVT_TABLE_DATA_EVENT_LEFT = getClassName('scheduler-view', 'table', 'data', 'event', 'left'),
    CSS_SVT_TABLE_DATA_EVENT_RIGHT = getClassName('scheduler-view', 'table', 'data', 'event', 'right'),
    CSS_SVT_TABLE_DATA_FIRST = getClassName('scheduler-view', 'table', 'data', 'first'),
    CSS_SVT_TABLE_GRID = getClassName('scheduler-view', 'table', 'grid'),
    CSS_SVT_TABLE_GRID_FIRST = getClassName('scheduler-view', 'table', 'grid', 'first'),
