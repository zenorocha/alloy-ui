...
var Lang = A.Lang,
    ...
    CSS_CONTAINER = getClassName('scheduler-view-agenda', 'container'),
    CSS_EVENT = getClassName('scheduler-view-agenda', 'event'),
    CSS_EVENT_COLOR = getClassName('scheduler-view-agenda', 'event', 'color'),
    CSS_EVENT_CONTENT = getClassName('scheduler-view-agenda', 'event', 'content'),
    CSS_EVENT_DATES = getClassName('scheduler-view-agenda', 'event', 'dates'),
    CSS_EVENT_FIRST = getClassName('scheduler-view-agenda', 'event', 'first'),
    CSS_EVENT_INFO = getClassName('scheduler-view-agenda', 'info'),
    CSS_EVENT_INFO_BIGGIE = getClassName('scheduler-view-agenda', 'info', 'biggie'),
    CSS_EVENT_INFO_CONTAINER = getClassName('scheduler-view-agenda', 'info', 'container'),
    CSS_EVENT_INFO_LABEL = getClassName('scheduler-view-agenda', 'info', 'label'),
    CSS_EVENT_INFO_LABEL_BIGGIE = getClassName('scheduler-view-agenda', 'info', 'label', 'biggie'),
    CSS_EVENT_INFO_LABEL_SMALL = getClassName('scheduler-view-agenda', 'info', 'label', 'small'),
    CSS_EVENT_LAST = getClassName('scheduler-view-agenda', 'event', 'last'),
    CSS_EVENT_NO_EVENTS = getClassName('scheduler-view-agenda', 'no', 'events'),
    CSS_EVENT_PAST = getClassName('scheduler-view-agenda', 'event', 'past'),
    CSS_EVENTS = getClassName('scheduler-view-agenda', 'events'),
    CSS_HEADER = getClassName('scheduler-view-agenda', 'header'),
    CSS_HEADER_DAY = getClassName('scheduler-view-agenda', 'header', 'day'),
    CSS_HEADER_EXTRA = getClassName('scheduler-view-agenda', 'header', 'extra'),
    CSS_HEADER_FIRST = getClassName('scheduler-view-agenda', 'header', 'first'),
    CSS_HEADER_LAST = getClassName('scheduler-view-agenda', 'header', 'last'),
