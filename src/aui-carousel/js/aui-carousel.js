...
var Lang = A.Lang,
    ...
    CSS_ITEM = getClassName('carousel', 'item'),
    CSS_ITEM_ACTIVE = getClassName('carousel', 'item', 'active'),
    CSS_ITEM_TRANSITION = getClassName('carousel', 'item', 'transition'),
    CSS_MENU_ACTIVE = getClassName('carousel', 'menu', 'active'),
    CSS_MENU_INDEX = getClassName('carousel', 'menu', 'index'),
    CSS_MENU_ITEM = getClassName('carousel', 'menu', 'item'),
    CSS_MENU_NEXT = getClassName('carousel', 'menu', 'next'),
    CSS_MENU_PLAY = getClassName('carousel', 'menu', 'play'),
    CSS_MENU_PAUSE = getClassName('carousel', 'menu', 'pause'),
    CSS_MENU_PREV = getClassName('carousel', 'menu', 'prev'),
