...
var Lang = A.Lang,
    ...
    CLASS_ENTRY = getClassName('ace-autocomplete', 'entry'),
    CLASS_ENTRY_CONTAINER = getClassName('ace-autocomplete', 'entry', 'container'),
    CLASS_ENTRY_CONTAINER_HIGHLIGHTED = getClassName('ace-autocomplete', 'entry', 'container', 'highlighted'),
    CLASS_ENTRY_EMPTY = getClassName('ace-autocomplete', 'entry', 'empty'),
    CLASS_ENTRY_LOADING = getClassName('ace-autocomplete', 'entry', 'loading'),
    CLASS_LOADING = getClassName('ace-autocomplete', 'entry', 'loading'),
    CLASS_RESULTS_LIST = getClassName('ace-autocomplete', 'results'),
